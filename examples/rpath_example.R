# This example reproduces the fictional "R Ecosystem" model from the 
# Rpath vignette. It saves two versions of the model to csv files, one 
# pre-stanza-calculation, and one post.

#--------------------
# Setup
#--------------------

# Uncomment these lines to redownload and compile the Rpath module
...
dir.create('REcoPreStanza')
dir.create('REcoPostStanza')

# Write version without stanza calculations filled in

write.rpath.params(REco.params, 'REco', 'REcoPreStanza')

# Calculate stanza details, and write a new version

REco.params <- rpath.stanzas(REco.params)
write.rpath.params(REco.params, 'REco', 'REcoPostStanza')
